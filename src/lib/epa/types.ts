...
export type Violation = { id: string | null; pwsid: string; contaminantCode: string | null; contaminantName: string | null; contaminantCategory: string | null; healthBased: boolean | null; compliancePeriod: { begins: string | null; ends: string | null }; resolved: boolean | null; status: string | null };
