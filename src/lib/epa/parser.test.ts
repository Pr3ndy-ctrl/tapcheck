...
test("parses a saved live EPA VIOLATION response", async () => {
  ...
  assert.deepEqual(violation, { id: "0106001022950102018", pwsid: "010106001", contaminantCode: "2950", healthBased: true, compliancePeriod: { begins: "2018-10-01 00:00:00", ends: "2018-12-31 00:00:00" }, resolved: true, status: "R" });
});
